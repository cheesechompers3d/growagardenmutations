  ...
  return (
    <div className="transition-all duration-300 relative after:absolute after:inset-0 after:bg-gradient-to-br after:from-purple-500/30 after:via-pink-400/25 after:to-blue-400/20 after:animate-pulse after:z-0 before:absolute before:inset-0 before:bg-gradient-to-tl before:from-blue-500/20 before:via-cyan-400/15 before:to-purple-400/10 before:animate-pulse before:z-0">
      <div ref={gameFrameRef} className={cn(
        " w-full shadow-2xl bg-gradient-to-br from-gray-900 via-gray-800 to-black z-10",
        isMobile
          ? "w-full min-h-[320px]"
          : isPlaying
            ? "w-full aspect-[16/5.5]"
            : "w-full"
      )}>
        ...
        {isPlaying ? (
          ...
          <>
            {/* 黑色背景区块，风格与第二张图一致 */}
            <div className="bg-gradient-to-br from-gray-900 via-black to-gray-800 flex flex-col items-center justify-start w-full">
              <div className="w-full flex flex-col items-center justify-start">
                ...
                <div className={cn(
                  ...
                  <h1 className={cn(
                    "font-bold mb-1",
                    isMobile ? "text-white text-lg whitespace-nowrap" : "text-white text-5xl whitespace-nowrap"
                  )}><span role="img" aria-label="game" className="inline-block text-[unset] filter-none align-middle mr-2">🎮</span> {game.title}</h1>
                  <div className={cn(
                    "font-semibold mb-1",
                    isMobile ? "text-green-500 text-sm" : "text-green-500 text-2xl"
                  )}>
                    <span role="img" aria-label="tag" className="inline-block text-[unset] filter-none align-middle mr-2">🏷️</span> {game.featuresTags}
                  </div>
                  <p className={cn(
                    "mx-auto mb-2",
                    isMobile ? "text-white text-xs max-w-full" : "text-white text-xl max-w-4xl"
                  )}><span role="img" aria-label="desc" className="inline-block text-[unset] filter-none align-middle mr-2">📝</span> {game.description}</p>
                  <div className={cn(
                    ...
                    <div className={cn(
                      ...
                      >
                        <span>{game.slug === "steal-a-brainrot" ? "Play Grow a Garden" : "Play Grow a Garden"}</span>
                      </button>
                    </div>
                  </div>
                </div>
